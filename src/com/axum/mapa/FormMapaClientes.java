...
public class FormMapaClientes extends FragmentActivity implements OnMarkerClickListener{
	...
	String POST="<?xml version=\"1.0\" encoding=\"utf-8\"?>"
		+"<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
		  ...
		  +"<lastPositionFor xmlns=\"http://tempuri.org/\">"
		     ...
		     +" <vendedorId>"+getConfig("vend")+"</vendedorId>"
		   +" </lastPositionFor>"
		  +"</soap:Body>"
		+"</soap:Envelope>";
...
+"<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
  +"<soap:Body>"
    +"<vistisOnDate xmlns=\"http://tempuri.org/\">"
      +"<userName>"+getConfig("empresa")+"rep</userName>"
      +"<aDate>"+s1+"</aDate>"
...
private class HttpAsyncTask extends AsyncTask<String, Void, String> {
  ...
  protected String doInBackground(String... urls) {
	    ...
	    Log.w("ALL CLIENTES",allClintes);
	   String visitados= getPOST(urls,getBody2());
	   Log.w("VISITAS",visitados);
 ...
 protected void onPreExecute() {
   ...
   ///String respuesta[]=result.split("@");
   	 ...
   	 if(s1.length()>0){
   		  ...
   		  // Log.w("DATO CANT", t+"");
		   	   	String s[]=s1.split(",");
		   	   	FormMapaClientes.this.setTitle("Vend: "+vendId+"  ["+s[3]+"]");
...
public void volver(){
	...
	mainIntent = new Intent().setClass(FormMapaClientes.this, Clientes.class);
	mainIntent.putExtra("idCliente","");
